...
CAFFE2_API std::tuple<Tensor &,Tensor &> eig_cuda_out(Tensor & e, Tensor & v, const Tensor & self, bool eigenvectors=false);
CAFFE2_API std::tuple<Tensor,Tensor> eig_cuda(const Tensor & self, bool eigenvectors=false);
